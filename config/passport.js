                ...
                await JSON.stringify(pool.query('SELECT id FROM users WHERE username=($1)', [req.body.username], (err, result) => {
                    ...
                    if (!testUser(req.body.username)) {
                        ...
                        if (result.rows[0]) {
                            ...
                            pool.query('INSERT INTO users (id, username, password, name, phone, email) VALUES ($1, $2, $3, $4, $5, $6)', [uuidv4(), req.body.username, passHash, req.body.name, req.body.phone, req.body.email], (err, result) => {
                                if (err) {
                                    console.log(err)
                                }
                                else {
